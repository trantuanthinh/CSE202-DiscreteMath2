...
public class IsConnected {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < queries; i++) {
            ...
            if (checkExistPath(startVertex, destinationVertex)) {
    ...
    static public Vertex[] readGraph(int numberOfVertices, int numberOfEdges) {
        ...
        for (int i = 0; i < numberOfEdges; ++i) {
            ...
            if (!verticesList[v].adjacentVertices.contains(verticesList[u])) {
    ...
    static public boolean checkExistPath(Vertex start, Vertex end) {
        List<Vertex> checkList = start.adjacentVertices;
        for (int i = 0; i < start.adjacentVertices.size(); i++) {
            if (checkList.get(i).id == end.id) {
                return true;
            }
        }
        return false;
