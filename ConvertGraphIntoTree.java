...
//100 done
public class ConvertGraphIntoTree {
    ...
    public static void main(String[] args) throws IOException {
        ...
        /*
         * Method 1:
         * int addedEdges = connectedComponents - 1;
         * int removedEdges = edgesNumber - verticesNumber + connectedComponents;
         * int totalEdges = addedEdges + removedEdges;
         */

        /*
         * Method 2:
         * int totalEdges = edgesNumber - verticesNumber + 2 * connectedComponents - 1;
         */
