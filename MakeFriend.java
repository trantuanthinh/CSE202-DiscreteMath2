...
public class MakeFriend {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < verticesList.length - 1; i++) {
            stringBuilder.append(verticesList[i].id).append(" ");
            stringBuilder.append(verticesList[i].getDegree()).append(" ");
            List<Integer> listAdjacentVertex = new ArrayList<>();
            for (Vertex vertex : verticesList[i].adjacentVertices) {
                listAdjacentVertex.add(vertex.id);
            }
            Collections.sort(listAdjacentVertex);
            for (int id : listAdjacentVertex) {
